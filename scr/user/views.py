...
from rest_framework.generics import GenericAPIView, CreateAPIView, RetrieveUpdateDestroyAPIView, UpdateAPIView, \
    get_object_or_404
...
from scr.user.serializers import *
...
class UsrTgUpdateAPIView(UpdateAPIView):
    queryset = User.objects.all()
    serializer_class = UserTgModelSerializer
